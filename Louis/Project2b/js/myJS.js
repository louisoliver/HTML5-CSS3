...
/* ----------------------------------------------------------------------------
    ...
    MOBILE DEVICES NENU SCRIPT

-------------------------------------------------------------------------------*/
/*this code will open the menu when the user clicks the menu icon(navBtn) and  close when the user clicks anything else. */
...
-------------------------------------------------------------------------------*/
/* self invoking function no associated action e.g. click as above */
$(function () {

    $(".navC a, actionB a, .logicC a").bind("click", function (event) {
